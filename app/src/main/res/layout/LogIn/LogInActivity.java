...
import com.real_cash.earning_app.All_StoreClass.ClickControl;
        ...
        logInButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (clickControl.getScore() <=0){
                    ...
                    Toast.makeText(LogInActivity.this, "Please clear this app data first", Toast.LENGTH_SHORT).show();
                }
